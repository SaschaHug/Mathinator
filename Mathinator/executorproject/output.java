...
public class HistoryMenuAssert extends ActivityInstrumentationTestCase2<Mathinator> {
	...
	public void testRun() {
        ...
        //Click on History
		solo.clickOnView(solo.getView(com.example.android.notepad.R.id.history_button));
		...
		assertTrue("'Gleichung' is not shown!", solo.waitForView(solo.getView(com.example.android.notepad.R.id.tvEquation, 5)));
	}
}
